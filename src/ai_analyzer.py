"""AI 分析引擎 — DeepSeek v4 Pro 阿里云百炼中转 — v2.0 四维框架"""
import json
import requests
...
3. **情绪/资金面** — VIX期限结构、Put/Call隐含情绪、板块资金流向、成交量异动
4. **宏观/事件面** — 利率概率、经济日历、地缘政治、政策事件
...
要求：1800-2500字，每个判断有数据支撑，多空观点平衡呈现。"""
...
def generate_daily_report(
    ...
    exec_instruction = "报告开头必须包含一段 100-150 字的 Executive Summary。"
